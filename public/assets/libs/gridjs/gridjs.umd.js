    ...
    for (n.__k = [], c = 0; c < e.length; c++)
      if (
        ...
        I(t, f, (h = h || _), i, o, s, a, u, l),
          ...
          null != d
            ? (null == g && (g = d),
              "function" == typeof f.type && null != f.__k && f.__k === h.__k
                ? (f.__d = u = F(f, u, t))
                : (u = T(t, f, h, y, d, u)),
              l || "option" !== n.type
    ...
    try {
      t: if ("function" == typeof N) {
        ...
        (p.context = C),
          ...
          (x =
            null != c && c.type === P && null == c.key ? c.props.children : c),
          ...
          : (e.__e = (function (t, e, n, r, i, o, s, a) {
              ...
              if (("svg" === d && (i = !0), null != o))
                for (; g < o.length; g++)
                  if (
                    (u = o[g]) &&
                    (u === t || (d ? u.localName == d : 3 == u.nodeType))
                  ) {
                    (t = u), (o[g] = null);
                    break;
                  }
              ...
              if (null === d) h === f || (a && t.data === f) || (t.data = f);
                ...
                if (
                  ...
                  if (null != o)
                    for (h = {}, p = 0; p < t.attributes.length; p++)
          ...
          if (this.props.pluginId) {
            ...
            return e
              ? b(
                  P,
                  {},
                  b(e.component, r({ plugin: e }, e.props, this.props.props))
                )
              : null;
          }
          ...
          return (
            ...
            b(
              ...
              this.isResizable() &&
                ...
                b(Zt, { column: this.props.column, thRef: this.thRef })
            )
          );
        }),
        e
            ...
            b(
              "div",
              {
                ...
                className: nt(
                  "gridjs",
                  et("container"),
                  this.state.status === Dt.Loading ? et("loading") : null,
    ...
    ie = (function (t) {
      function e(e) {
        ...
        return (
          ...
          (n.plugin = void 0),
          (n.config = new Mt({ instance: s(n), eventEmitter: s(n) }).update(e)),
          ...
          return (
            ...
            t.childNodes.length > 0
              ? (lt.error(
                ...
                this)
              : ((this.config.container = t), j(this.createElement(), t), this)
          );
        }),
        e
      );
